...
<ul>
- le dataframe : la valeur selectionnée dependant du nom de la colonne, identifiée que par le nom du pays, ou par un fonction reactive (language) qui prend le nom du pays, et de la ligne, identifiée par le nom ou par l'index du ligne de la composante à traduire
<br>
